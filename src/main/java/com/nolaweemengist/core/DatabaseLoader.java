...
import com.nolaweemengist.user.User;
import com.nolaweemengist.review.Review;
import com.nolaweemengist.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        users.save(students);
        users.save(new User("Nolawee","Mengist","nmengist", "password",new String[] {"ROLE_USER"}));
